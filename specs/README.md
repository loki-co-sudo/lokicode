...
| [fix-roadmap-deepthink-400-crossplatform-shell.md](fix-roadmap-deepthink-400-crossplatform-shell.md) | **修正ロードマップ**: ディープシンク 400 解消・Mac/Linux 対応・ターミナルのシェル選択（実装手順書） | **修正1（400解消）実装済み**。修正2・修正3は未実装 |
